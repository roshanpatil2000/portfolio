      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="Amrita Vishwa Vidyapeetham (2021 - present)"
            result="-"
      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="VAA technologies - (April, 2022 - December 2022)"
            result="Boisar, Maharashtra"
            // des=""
          />
          <ResumeCard
            title="Web Developer & Trainer"
            subTitle="Anand Controls - (September, 2021 - March,2022 )"
            result="Boisar, Maharashtra"
